        ...
        static void Main(string[] args)
        {
            ...
            if (Args.Length > 0)
            {
                switch (Args[0].ToUpper())
                {
                    case "/UNLOCK":
                        ...
                        var AllProcess = Process.GetProcessesByName("CSFSecurityProxy");
            ...
            else
            {
                ...
                if (!Utils.IsWinVistaOrHigher())
                {
                    ...
                    "CSFSecurityProxy Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                using (Mutex mutex = new Mutex(false, $"Global\\Shadowsocks_{Application.StartupPath.GetHashCode()}"))
                {
                    ...
                    if (!mutex.WaitOne(0, false))
                    {
                        ...
                        MessageBox.Show(I18N.GetString("Find CSFSecurityProxy icon in your notify tray.")
                            + Environment.NewLine
                ...
                Logging.OpenLogFile();
                    ...
                    //Thread.Sleep(1000);
                    //File.Delete($"{Environment.CurrentDirectory}\\PAC.txt");
